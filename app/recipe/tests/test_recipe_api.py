...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning and existing tags when apdating recipe"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            "title": "Cliflower Tacos",
            "time_minutes": 60,
            "price": Decimal("4.50"),
            "ingredient": [{"name": "Culliflower"}, {"name": "Salt"}]
        }
        res = self.client.post(RECIPES_URL, payload, format="json")
        ...
        for ingredients in payload["ingredient"]:
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test creating a recipe with existng ingredient."""
        ingredient = Ingredient.objects.create(user=self.user, name="Lemon")
        payload = {
            "title": "Vietnames Soup",
            "time_minutes": 25,
            "price": Decimal("2.25"),
            "ingredient": [{"name": "Lemon"}, {"name": "Fish Soace"}]
        }
        res = self.client.post(RECIPES_URL, payload, format="json")
    ...
    def test_create_ingredient_on_update(self):
        """Test create an ingredient when update recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title="Aubegin")
    ...
    def test_filter_by_ingredients(self):
        """Test filtering by recipes by ingredients."""
        r1 = create_recipe(user=self.user, title="Push beans on toasts")
        r2 = create_recipe(user=self.user, title="chiecken")
        in1 = Ingredient.objects.create(user=self.user, name="Feta Chese")
        in2 = Ingredient.objects.create(user=self.user, name="Chiecken")
        r1.ingredient.add(in1)
        r2.ingredient.add(in2)
        r3 = create_recipe(user=self.user, title="Red Lintel Doll")
